export const workout = {
  ...
  setRow: {
    ...
    previousFill: "Previous: {{display}}. Tap to fill.",
    previousEmpty: "No previous data",
    weightForSet: "Weight in {{unit}} for {{set}}",
    repsForSet: "Reps for {{set}}",
    rpeForSet: "RPE for {{set}}: {{value}}",
    rpeNotSet: "not set",
