export const accountSettings = {
  ...
  export: {
    ...
    formatHelp: {
      ...
      pdf: "Training charts, workout totals, and personal records.",
    },
    report: {
      title: "Training report",
      allTime: "All training history",
      workouts: "Workouts",
      ...
      weeklyTitle: "Workouts per week",
      weeklyEmpty: "No completed workouts in this chart period.",
      volumeTitle: "Recent workout volume",
      ...
      personalRecordsSubtitle:
        "Up to 10 records from all completed workouts. Volume = weight × reps; 1RM is estimated.",
