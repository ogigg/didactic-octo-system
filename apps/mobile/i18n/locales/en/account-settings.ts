export const accountSettings = {
  ...
  export: {
    ...
    description: "Download your training data or a coach-ready PDF report.",
    ...
    formatHelp: {
      ...
      pdf: "A coach-friendly report with progress charts, summaries, and all-time personal records.",
    },
    report: {
      title: "Training progress report",
      subtitle:
        "A concise overview of training consistency, workload, and performance for sharing with a coach.",
      generated: "Generated",
      period: "Period (days)",
      workouts: "Workouts",
      ...
      progressInsufficient:
        "Complete at least four workouts with logged weight and reps to show a volume trend.",
      volumeIncreased:
        "Average volume per workout increased by {{percent}}% in the more recent half of this period.",
      volumeDecreased:
        "Average volume per workout decreased by {{percent}}% in the more recent half of this period.",
      volumeSteady:
        "Average volume per workout remained steady across this period.",
      ...
      personalRecordsEmpty: "No weighted personal records are available yet.",
      exercise: "Exercise",
      bestWeight: "Best weight",
      bestSetVolume: "Best set volume",
      estimatedOneRepMax: "Estimated 1RM",
      recentWorkoutsTitle: "Recent workout detail",
      date: "Date",
      workout: "Workout",
      sets: "Sets",
      volume: "Volume",
      ...
      sessions: "sessions",
      footer:
        "Generated by Sweaty from completed workout logs. Review training decisions with a qualified coach.",
    },
