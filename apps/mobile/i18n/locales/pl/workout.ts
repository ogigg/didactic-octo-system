export const workout = {
  ...
  setRow: {
    ...
    workingSet: "seria {{number}}",
    previousFill: "Poprzednio: {{display}}. Dotknij, aby uzupełnić.",
    previousEmpty: "Brak poprzednich danych",
    weightForSet: "Ciężar w {{unit}} dla {{set}}",
    repsForSet: "Powtórzenia dla {{set}}",
    rpeForSet: "RPE dla {{set}}: {{value}}",
    rpeNotSet: "nie ustawiono",
    completeToggle: "{{set}}: {{status}}{{record}}",
    completed: "ukończona",
    notCompleted: "nieukończona",
  ...
  summary: {
    ...
    share: {
      ...
      dialogTitle: "Udostępnij trening",
      unavailableTitle: "Udostępnianie niedostępne",
      unavailableMessage:
        "Udostępnianie nie jest teraz dostępne na tym urządzeniu.",
      errorTitle: "Nie udało się udostępnić",
      errorMessage:
        "Nie udało się utworzyć obrazka treningu. Spróbuj ponownie.",
      brand: "Sweaty",
      eyebrow: "Trening ukończony",
      dateLabel: "Zakończono",
      volumeLabel: "Całkowita objętość",
      bodyweight: "Masa ciała",
      durationLabel: "Czas",
      setsLabel: "Serie",
      setsValue: "{{completed}}/{{total}}",
      completionLabel: "Ukończono",
      streakLabel: "Seria tygodni",
      exercisesTitle: "Najważniejsze ćwiczenia",
      bestLabel: "Najlepiej",
