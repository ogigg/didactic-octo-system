...
export default function FeedbackScreen() {
  ...
  const { recoveryReference } = useLocalSearchParams<{
  ...
  const {
    ...
    defaultValues: {
      type: "bug_report",
      title: recoveryReference ? t("recovery.title") : "",
      description: recoveryReference
        ? t("recovery.description", { reference: recoveryReference })
        : "",
    },
  });
