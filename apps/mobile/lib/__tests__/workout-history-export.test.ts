...
const reportCopy: CoachReportCopy = {
  ...
  progressInsufficient: "More workouts required.",
  volumeIncreased: "Volume increased {{percent}}%.",
  volumeDecreased: "Volume decreased {{percent}}%.",
  volumeSteady: "Volume stayed steady.",
