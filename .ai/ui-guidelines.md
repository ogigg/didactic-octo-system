...
**Design philosophy:** Content-first, minimal chrome. Inspired by Hevy's functional clarity but with a more modern, refined aesthetic. Everything the user needs is one tap away — no visual clutter.
