-- Add optional warmup_sets to get_exercise_progression_history.
-- working_sets remain the only input for progression; warmup_sets feed previous-display UI.
-- Keep auth grants, ordering, RPE, and duration support from the prior enrichment migration.
