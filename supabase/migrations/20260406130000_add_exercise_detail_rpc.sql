-- -----------------------------------------------------------------------------
-- Migration: add_exercise_detail_rpc
-- Returns per-exercise personal records, weekly volume, and session history
-- in a single RPC call for the exercise detail screen.
-- -----------------------------------------------------------------------------
...
BEGIN
  ...
  RETURN jsonb_build_object(
    'records',      COALESCE(v_records, jsonb_build_object(
      'max_weight_kg', 0, 'max_reps', 0, 'max_volume_set_kg', 0,
